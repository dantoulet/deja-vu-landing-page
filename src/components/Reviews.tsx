...
export const Reviews = () => {
  ...
  return (
    <div 
      className="grid md:grid-cols-2 gap-8 md:gap-4 max-w-4xl py-8"
      itemScope
    ...
    >
      {reviews.map((review, index) => (
        <Card 
          key={index} 
          className="p-6 bg-white shadow-sm hover:shadow transition-shadow duration-200 flex flex-col min-h-[180px] border-none"
          itemScope
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <div className="mt-auto pt-6 border-t border-gray-100">
              <p 
                className="text-sm text-gray-600 font-semibold text-right"
                itemProp="author"
                itemScope
